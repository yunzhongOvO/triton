...
auto getMfmaInsnGroupAttrMap = []() -> const MfmaInsnGroupMap & {
  static MfmaInsnGroupMap MfmaInsnMap{
      ...
      {{4, 64, MfmaTypeId::Fp16TyId, 3},
       {4, 64, 64, 4, 4, ROCDL::mfma_f32_4x4x4f16::getOperationName()}},
      ...
      {{32, 32, MfmaTypeId::Fp8Fp8TyId, 3},
       {32, 32, 16, 8, 8, ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
      // mfma_f32_16x16x32_FP8_FP8
      {{16, 16, MfmaTypeId::Fp8Fp8TyId, 3},
       {16, 16, 32, 8, 8, ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
      // mfma_f32_32x32x16_FP8_BF8
      {{32, 32, MfmaTypeId::Fp8Bf8TyId, 3},
       {32, 32, 16, 8, 8, ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
      // mfma_f32_16x16x32_FP8_BF8
      {{16, 16, MfmaTypeId::Fp8Bf8TyId, 3},
       {16, 16, 32, 8, 8, ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
      // mfma_f32_32x32x16_BF8_FP8
      {{32, 32, MfmaTypeId::Bf8Fp8TyId, 3},
       {32, 32, 16, 8, 8, ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
      // mfma_f32_16x16x32_BF8_FP8
      {{16, 16, MfmaTypeId::Bf8Fp8TyId, 3},
       {16, 16, 32, 8, 8, ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
      // mfma_f32_32x32x16_BF8_BF8
      {{32, 32, MfmaTypeId::Bf8Bf8TyId, 3},
       {32, 32, 16, 8, 8, ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
      // mfma_f32_16x16x32_BF8_BF8
      {{16, 16, MfmaTypeId::Bf8Bf8TyId, 3},
       {16, 16, 32, 8, 8, ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}}};
  return MfmaInsnMap;
};
...
unsigned MfmaInsn::getKBaseA() { return attr.kBase_a; }
unsigned MfmaInsn::getKBaseB() { return attr.kBase_b; }
